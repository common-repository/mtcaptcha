function check_validation() {
    ...
    var site_Key = document.getElementById("mt_captcha_site_key");
...
function custom_captcha_enable_or_disable() {
    ...
    if (document.getElementById("mt_captcha_enable_json_value_check_disable").checked == true) {            
        document.getElementById("mt_captcha_site_key").disabled = true;
        ...
        document.getElementById("mt_captcha_site_key").disabled = false;
